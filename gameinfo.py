...
def CollectGameData(api_key, games):
    ...
    DW['cursor'].execute("SELECT gameids.gameid FROM league.gameids order by gameids.gameid desc limit %s;" % games)
    ...
    for gameid in gameids:
        ...
        if game_info['info']['queueId'] in [700,440,420,400]:
            ...
            for i in range(10):
                ...
                enemyTowerKills = game_info['info']['teams'][teamIndex]['objectives']['tower']['kills']
                enemyFirstTowerKill = game_info['info']['teams'][teamIndex]['objectives']['tower']['first']
                ...
                enemyDragonKills = game_info['info']['teams'][teamIndex]['objectives']['dragon']['kills']
                enemyFirstDragonKill = game_info['info']['teams'][teamIndex]['objectives']['dragon']['first']
                ...
                enemyHeraldKills = game_info['info']['teams'][teamIndex]['objectives']['riftHerald']['kills']
                enemyFirstHeraldKill = game_info['info']['teams'][teamIndex]['objectives']['riftHerald']['first']
                ...
                enemyBaronKills = game_info['info']['teams'][teamIndex]['objectives']['baron']['kills']
                enemyFirstBaronKill = game_info['info']['teams'][teamIndex]['objectives']['baron']['first']
                ...
                enemyInhibitorKills = game_info['info']['teams'][teamIndex]['objectives']['inhibitor']['kills']
                enemyFirstInhibitorKill = game_info['info']['teams'][teamIndex]['objectives']['inhibitor']['first']
                #Spell Cast Metrics
